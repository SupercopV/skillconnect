...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"{self.job.title} - ₹{self.amount} ({self.status})"
...
class Interview(models.Model):
    recruiter = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="interviews_scheduled"
    )
    freelancer = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="interviews_received"
    )
    job = models.ForeignKey(Job, on_delete=models.CASCADE)
