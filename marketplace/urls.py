...
urlpatterns = [
    ...
    path("interviews/create/<int:proposal_id>/", views.interview_create, name="interview_create"),

    path("interview/<int:interview_id>/complete/",views.interview_mark_completed,name="interview_complete"),
